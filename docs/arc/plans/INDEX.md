...
| `2026-07-13-frontend-runtime-remediation-implementation.md` | Repair frontend loading and refresh behavior | P1 | L | World Cup tasks 1–11 | IN PROGRESS | 2026-07-14 | Preserve staged optional-cloud publication during coordinator extraction. |
